  ...
  return (
    <div className="p-5 md:p-10">
      <div
        ...
        className="group bg-border/15 flex cursor-pointer flex-col items-center gap-4 border p-5 lg:flex-row lg:justify-between lg:p-10"
      >
        <div className="flex w-full justify-end lg:hidden">
          <div className="aspect-16/10 overflow-hidden border lg:max-w-[75%]">
            <img
